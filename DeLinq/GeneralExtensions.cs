...
public static class GeneralExtensions
{
    ...
    {
        return ExceptionCaster(exc)?.ToJson();
    }
    public static object? ExceptionCaster(this Exception? exc)
    {
        return exc is null ? null : new
        {
            exc.Message,
            exc.StackTrace,
            exc.Source,
            exc.Data,
            InnerException = ExceptionCaster(exc.InnerException)
